...
$character_type = $_GET['character'] ?? '토토로'; 
?>
...
<head>
    <meta charset="UTF-8">
    <title>방명록_토토로</title>
    <link rel="stylesheet" href="./css/guestbook3.css">
</head>
<body>
    <header>
        <div class="container">
            ...
            <div id="box">
                ...
                <p id="text">“이웃집 토토로" - <?= htmlspecialchars($character_type) ?> 유형</p>
        ...
        <div id="chat-container">
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class='message-wrapper'>
                    <img class='avatar' src='img/totoro_green.png' />
                    <div>
    ...
    <script>
        ...
        function sendMessage() {
            ...
            const avatars = ["img/totoro_green.png", "img/totoro_red.png"];
